  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
            <div className="flex flex-col items-start text-left space-y-4 md:pl-4">
                <svg
                ...
                <div className="mt-4 flex items-center justify-start gap-2 rounded-full border p-1 pr-3 w-fit">
            ...
            <div className="w-full text-left">
                <p className="text-sm mb-8">To continue, first verify it’s you</p>
